...
class BstTester(unittest.TestCase):
    ...
    def test_preorder(self):
        ...
        actual_data = [ROOT_DATA, LEFT_DATA, LL_DATA] + additional_data[0: 2] + [LR_DATA] + additional_data[2: 4] + [
            RIGHT_DATA, RL_DATA] + additional_data[4: 6] + [RR_DATA] + additional_data[6: 8]
    ...
    def test_postorder(self):
        ...
        actual_data = additional_data[0: 2] + [LL_DATA] + additional_data[2: 4] + [LR_DATA,
                                                                                   LEFT_DATA] + additional_data[
                                                                                                4: 6] + [
                          RL_DATA] + additional_data[6: 8] + [RR_DATA, RIGHT_DATA, ROOT_DATA]
